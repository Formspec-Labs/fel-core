...
pub(super) const ENTRIES: &[BuiltinFunctionCatalogEntry] = &[
    ...
    BuiltinFunctionCatalogEntry {
        ...
        parameters: &[Parameter {
            ...
            description: Some(
                "Either a single array argument or two or more scalar arguments (variadic scalar form).",
            ),
            required: true,
            variadic: true,
            allowed_values: None,
        ...
        returns: FelType::Number,
        return_description: None,
        description: "Returns the smallest finite numeric value. Accepts either `min([...])` (single array) or `min(a, b, ...)` (variadic scalars).",
        null_handling: Some("Null/non-numeric elements skipped. Empty array returns null."),
        deterministic: true,
        emit_deterministic_explicitly: false,
        short_circuit: false,
        examples: &[
            ...
            Example {
                expression: "min(5, 2, 8)",
                result_json: "2",
                note: Some("Variadic scalar form"),
            },
        ],
        since_version: "1.0",
        package: Package::Universal,
    ...
    BuiltinFunctionCatalogEntry {
        ...
        returns: FelType::Number,
        return_description: None,
        description: "Returns the largest finite numeric value. Accepts either `max([...])` (single array) or `max(a, b, ...)` (variadic scalars).",
        null_handling: Some("Null/non-numeric elements skipped. Empty array returns null."),
        deterministic: true,
        emit_deterministic_explicitly: false,
        short_circuit: false,
