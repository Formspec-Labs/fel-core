...
use chrono::Datelike;
use fel_core::{civil_from_days, days_from_civil, days_in_month};
...
proptest! {
    ...
    /// `days_from_civil` matches chrono's `num_days_from_ce` shifted by the epoch offset.
    #[test]
    fn days_from_civil_matches_chrono(
        year in 1900_i32..=2200_i32,
        month in 1_u32..=12_u32,
        // 1-31: prop_assume! below filters days that exceed the month's actual length.
        day in 1_u32..=31_u32,
    ) {
    ...
    /// Round-trip: `civil_from_days(days_from_civil(y, m, d))` == original date.
    #[test]
    fn round_trip_civil(
        year in 1900_i32..=2200_i32,
        month in 1_u32..=12_u32,
